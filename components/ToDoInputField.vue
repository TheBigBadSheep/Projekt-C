<template>
  <div class="relative flex justify-center w-full rounded-lg">
    <input
      v-model="item"
    ...
    <svg
      ...
      class="absolute right-4 h-full w-8 text-gray-300 hover:text-gray-600 transition ease-in-out duration-200 cursor-pointer"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
      stroke-width="2"
    ...
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      class="absolute right-16 h-full w-8 text-gray-300 hover:text-gray-600 transition ease-in-out duration-200 cursor-pointer"
    >
      <path
        fill-rule="evenodd"
